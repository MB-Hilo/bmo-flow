    ...
    $(document).ready(function() {
        ...
        function renderLayout(nodeJSON) {
            ...
            var transforms = {
                "parent": [{
                        "<>": "div",
                        "class": layoutType + " floatleft ${css}",
                        "id": "${id}",
                        "data-col": function() { return (currentCol) },
                        "children": [
                            { "<>": "div", "html": "<h3>${text}</h3>" },
                            {
                                "<>": "div",
                                "html": function() { return (json2html.transform(this.children, transforms.child)); },
                            }
                        ]
                    },
                ...
                "child": [{
                    ...
                    "children": [{
                        ...
                        "href": "${a_attr.href}",
                        "children": [
                            { "<>": "div", "class": "bmo-icon ${icon}", "html": "" }
                        ]
                    }, { "<>": "div", "class": "BMO-label", "html": "${text}" }]
                }]
            };
    ...
    //$("body").addClass("screenshotWidth");

    html2canvas($("#landingPage")).then(function(canvas) {
        var ctx = canvas.getContext('2d');
        ctx.font = "48px arial";
        //document.body.appendChild(canvas);
        // $("#screenshot").prepend(canvas);
        // var copyCanvas =  $("#screenshot").find("canvas").clone();
        $("#menu-screenshots").prepend(canvas);
        $("#menu-screenshots").find("canvas").eq(4).remove();
        // $("#screenshot").show();
        // $("#container").hide();
...
connectSlider.noUiSlider.on('update', function(values, handle) {
    $("#container").css("zoom", values[handle] + "%");
});